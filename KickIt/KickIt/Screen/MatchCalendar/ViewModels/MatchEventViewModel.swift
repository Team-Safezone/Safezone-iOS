...
extension MatchEventViewModel {
    static func withDummyData() -> MatchEventViewModel {
        ...
        viewModel.matchEvents = [
            MatchEventsData(matchId: 53, eventCode: 0, eventTime: "2024/10/30 15:00:00", eventName: "경기 시작", player1: nil, player2: nil, teamName: nil, teamUrl: nil),
            MatchEventsData(matchId: 53, eventCode: 1, eventTime: "2024/10/30 15:05:00", eventName: "골!", player1: "미트로비치", player2: "윌리안", teamName: "풀럼", teamUrl: pulurl),
                MatchEventsData(matchId: 53, eventCode: 1, eventTime: "2024/10/30 15:20:00", eventName: "교체", player1: "포든", player2: "그릴리쉬", teamName: "맨시티", teamUrl: manurl),
                MatchEventsData(matchId: 53, eventCode: 1, eventTime: "2024/10/30 15:35:00", eventName: "경고", player1: "홀란드", player2: nil, teamName: "맨시티", teamUrl: manurl),
                MatchEventsData(matchId: 53, eventCode: 2, eventTime: "2024/10/30 15:45:00", eventName: "하프타임", player1: "3", player2: "2", teamName: nil, teamUrl: nil),
                MatchEventsData(matchId: 53, eventCode: 3, eventTime: "2024/10/30 16:10:00", eventName: "자책골", player1: "아케", player2: nil, teamName: "맨시티", teamUrl: manurl),
                MatchEventsData(matchId: 53, eventCode: 3, eventTime: "2024/10/30 16:25:00", eventName: "VAR 판독", player1: "홀란드", player2: nil, teamName: nil, teamUrl: nil),
                MatchEventsData(matchId: 53, eventCode: 4, eventTime: "2024/10/30 16:37:00", eventName: "추가 선언", player1: "5", player2: nil, teamName: nil, teamUrl: nil),
                MatchEventsData(matchId: 53, eventCode: 5, eventTime: "2024/10/30 16:40:00", eventName: "골!", player1: "데브라위너", player2: "알바레즈", teamName: "맨시티", teamUrl: manurl)
        ]
        
        viewModel.matchStartTime = DateFormatter().date(from: "2024/10/30 15:00")
        viewModel.userAverageHeartRate = 75
        viewModel.currentMatchId = 53
        
        // Dummy heart rate data
        viewModel.heartRateRecords = [
            HeartRateDate(heartRate: 80, date: "2024/10/30 15:05"),
            HeartRateDate(heartRate: 85, date: "2024/10/30 15:20"),
            HeartRateDate(heartRate: 90, date: "2024/10/30 15:35"),
            HeartRateDate(heartRate: 75, date: "2024/10/30 15:45"),
            HeartRateDate(heartRate: 95, date: "2024/10/30 16:10"),
            HeartRateDate(heartRate: 88, date: "2024/10/30 16:25"),
            HeartRateDate(heartRate: 92, date: "2024/10/30 16:40")
        ]

...
final class SoccerDiaryViewModel: ObservableObject {
    @Published var recommendDiarys: [RecommendSoccerDiaryViewModel] = [] // 추천 축구 일기 리스트

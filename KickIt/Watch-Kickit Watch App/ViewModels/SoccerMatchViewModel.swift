...
class SoccerMatchViewModel: NSObject, ObservableObject {
    ...
    private func setupWatchSessionManager() {
        WatchosSessionManager.shared.onXAuthTokenReceived = { [weak self] token in
